...
public class HipsterLaunch : FGAction
{
    public HipsterLaunch(int duration = 30, bool looping = false, int loopFrame = 0) : base(duration, looping, loopFrame)
    {
        ...
        hitboxes[2][0] = new FGHitbox(new UnityEngine.Rect(-0.3f, 2.2f, 1.6f, 1.6f), new UnityEngine.Vector2(15f, 90));
        hitboxes[4] = new FGHitbox[1];
        hitboxes[4][0] = new FGHitbox(new UnityEngine.Rect(0.2f, 2.4f, 0.6f, 1.2f), new UnityEngine.Vector2(10f, 50));
